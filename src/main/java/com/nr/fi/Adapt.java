...
public class Adapt {
  ...
  final double[] x = new double[]{0,-x1,-alpha,-x2,-beta,-x3,0.0,x3,beta,x2,alpha,x1};
  ...
  public double integrate(final UniVarRealValueFun func, final double a, final double b) {
  ...
  public double adaptlob(final UniVarRealValueFun func, final double a, final double b, final double fa,
