...
public abstract class Stiel {
  ...
  public Stiel(final int nn, final double aaa, final double bbb, final double hmaxx) {
    n =nn;
    aa= aaa;
    bb=bbb;
    hmax=hmaxx;
  ...
  public void get_weights(final double[] x, final double[] w){
    ...
    if (n != x.length) throw new IllegalArgumentException("bad array size in Stiel");
    for (int i=0;i<n;i++) {
      j=i;
      c=quad(s1);
      b[i]=c/oldc;
  ...
  public double wt1(final double x, final double del){return -9999;}
  public double wt2(final double x){return -9999;}
  public double fx(final double t){return -9999;}
  public double fdxdt(final double t){return -9999;}
