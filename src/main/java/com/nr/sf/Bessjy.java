...
public class Bessjy { 
  ...
  private static final double j0r[]={1.682397144220462e-4,2.058861258868952e-5,
    5.288947320067750e-7,5.557173907680151e-9,2.865540042042604e-11,
    7.398972674152181e-14,7.925088479679688e-17};
  private static final double j0s[]={1.0,1.019685405805929e-2,5.130296867064666e-5,
    1.659702063950243e-7,3.728997574317067e-10,
    5.709292619977798e-13,4.932979170744996e-16};
  private static final double j0pn[]={9.999999999999999e-1,1.039698629715637,
    2.576910172633398e-1,1.504152485749669e-2,1.052598413585270e-4};
  private static final double j0pd[]={1.0,1.040797262528109,2.588070904043728e-1,
    1.529954477721284e-2,1.168931211650012e-4};
  private static final double j0qn[]={-1.562499999999992e-2,-1.920039317065641e-2,
    -5.827951791963418e-3,-4.372674978482726e-4,-3.895839560412374e-6};
  private static final double j0qd[]={1.0,1.237980436358390,3.838793938147116e-1,
    3.100323481550864e-2,4.165515825072393e-4};
  private static final double j1r[]={7.309637831891357e-5,3.551248884746503e-6,
    5.820673901730427e-8,4.500650342170622e-10,1.831596352149641e-12,
    3.891583573305035e-15,3.524978592527982e-18};
  private static final double j1s[]={1.0,9.398354768446072e-3,4.328946737100230e-5,
    1.271526296341915e-7,2.566305357932989e-10,
    3.477378203574266e-13,2.593535427519985e-16};
  private static final double j1pn[]={1.0,1.014039111045313,2.426762348629863e-1,
    1.350308200342000e-2,9.516522033988099e-5};
  private static final double j1pd[]={1.0,1.012208056357845,2.408580305488938e-1,
    1.309511056184273e-2,7.746422941504713e-5};
  private static final double j1qn[]={4.687499999999991e-2,5.652407388406023e-2,
    1.676531273460512e-2,1.231216817715814e-3,1.178364381441801e-5};
  private static final double j1qd[]={1.0,1.210119370463693,3.626494789275638e-1,
    2.761695824829316e-2,3.240517192670181e-4};
  private static final double y0r[]={-7.653778457189104e-3,-5.854760129990403e-2,
  ...
  private static final double y0s[]={1.0,1.125494540257841e-2,6.427210537081400e-5,
  ...
  private static final double y0pn[]={9.999999999999999e-1,1.039698629715637,
    2.576910172633398e-1,1.504152485749669e-2,1.052598413585270e-4};
  private static final double y0pd[]={1.0,1.040797262528109,2.588070904043728e-1,
    1.529954477721284e-2,1.168931211650012e-4};
  private static final double y0qn[]={-1.562499999999992e-2,-1.920039317065641e-2,
    -5.827951791963418e-3,-4.372674978482726e-4,-3.895839560412374e-6};
  private static final double y0qd[]={1.0,1.237980436358390,3.838793938147116e-1,
    3.100323481550864e-2,4.165515825072393e-4};
  private static final double y1r[]={-1.041835425863234e-1,-1.135093963908952e-5,
  ...
  private static final double y1s[]={1.0,1.186694184425838e-2,7.121205411175519e-5,
    2.847142454085055e-7,8.364240962784899e-10,1.858128283833724e-12,
    3.018846060781846e-15,3.015798735815980e-18};
  private static final double y1pn[]={1.0,1.014039111045313,2.426762348629863e-1,
    1.350308200342000e-2,9.516522033988099e-5};
  private static final double y1pd[]={1.0,1.012208056357845,2.408580305488938e-1,
    1.309511056184273e-2,7.746422941504713e-5};
  private static final double y1qn[]={4.687499999999991e-2,5.652407388406023e-2,
    1.676531273460512e-2,1.231216817715814e-3,1.178364381441801e-5};
  private static final double y1qd[]={1.0,1.210119370463693,3.626494789275638e-1,
    2.761695824829316e-2,3.240517192670181e-4};
  ...
  public void rat(final double x, final double[] r, final double[] s, final int n) {
    y = x*x;
    z=64.0-y;
    nump=r[n];
    denp=s[n];
  ...
  public void asp(final double[] pn, final double[] pd, final double[] qn, final double[] qd,
    final double fac) {
    z=8.0/ax;
    y=z*z;
    xx=ax-fac*pio4;
  ...
  public double jn(final int n, final double x){
    ...
    if (n==1) return j1(x);
    ax=abs(x);
    if (ax*ax <= 8.0*Double.MIN_NORMAL) return 0.0;
    else if (ax > n) {
      tox=2.0/ax;
      bjm=j0(ax);
      bj=j1(ax);
