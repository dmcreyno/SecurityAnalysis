...
public class Output {
   ...
   * @param h
   */
  public void save_dense(final StepperBase s, final double xout, final double h) {
  ...
  public void out(final int nstp,final double x,final double[] y,final StepperBase s,final double h) {
    if (!dense)
