...
public abstract class StepperBase {
   ...
   * @param dense
   */
  void setParam(final double[] yy, final double[] dydxx, final double xx, final double atoll, // XXX reference xx.
  ...
  public StepperBase(final double[] yy, final double[] dydxx, final double xx, final double atoll, // XXX reference xx.
    final double rtoll, final boolean dense) {
