...
public class Machar {
  ...
  public void report() {
    System.out.printf("quantity:  numeric_limits<double> says  (we calculate)\n");
    System.out.printf("radix:  %d  (%d)\n", FLT_RADIX, ibeta);
    System.out.printf("mantissa digits:  %d  (%d)\n",DBL_MANT_DIG, it);
    System.out.printf("round style:  %d  (%d) [our 5 == IEEE 1]\n",1, irnd); // round_style=1
